...
```{r}
library(readr)
fivethirtyeight_election_deniers_Gov50_final <- read_csv("~/Downloads/fivethirtyeight_election_deniers_Gov50_final.csv")
View(fivethirtyeight_election_deniers_Gov50_final)
```
